...
read -rp "IMPROVE_TIMEOUT_SECONDS [90]: " IMPROVE_TIMEOUT_SECONDS
IMPROVE_TIMEOUT_SECONDS=${IMPROVE_TIMEOUT_SECONDS:-90}
read -rp "FILE_OPS_TIMEOUT_SECONDS [90]: " FILE_OPS_TIMEOUT_SECONDS
FILE_OPS_TIMEOUT_SECONDS=${FILE_OPS_TIMEOUT_SECONDS:-90}
read -rp "PIPELINE_TIMEOUT_SECONDS [240]: " PIPELINE_TIMEOUT_SECONDS
...
IMPROVE_TIMEOUT_SECONDS=${IMPROVE_TIMEOUT_SECONDS}
FILE_OPS_TIMEOUT_SECONDS=${FILE_OPS_TIMEOUT_SECONDS}
